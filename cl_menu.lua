print("^0======================================================================^7")
print("^0[^6Author^0] ^1:^0 ^1BabyLua^1")
print("^0[^6Version^0] ^1:^0 ^02.0^1")
print("^0======================================================================^7")
...
reportlistesql = {}
----------------------------------------------------------------------------------------------------
--------------------------------  BabyLua https://discord.gg/hhGdUJVyFe --------------
----------------------------------------------------------------------------------------------------
RMenu.Add('menu', 'main', RageUI.CreateMenu("Menu Admin", " "))
RMenu.Add('menu', 'options', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Admin", " "))
...
local WarnType = {
    ...
    "~r~→~s~ Power Gaming",
    "~r~→~s~ Insultes",
    "~r~→~s~ Non respect du staff",
    "~r~→~s~ Meta Gaming",
    "~r~→~s~ Force RP",
    "~r~→~s~ Free Shoot",
    "~r~→~s~ Free Punch",
    "~r~→~s~ Tire en zone safe",
    "~r~→~s~ Non respect du mass RP",
    "~r~→~s~ Autre... ~r~(Entrer la raison)~s~",
}
...
function ReloadColor()
    Citizen.CreateThread(function()
        ...
        for k,v in pairs(AllMenuToChange) do
            RMenu:Get('menu', v):SetRectangleBanner(92, 2, 31 )
            for name, menu in pairs(RMenu['menu']) do
...
--------------------------------------------------------------------------------------------------------------------------------------------------------
					...
					if InStaff then
						RageUI.Separator("~o~→~s~-------[ Tenu à prendre ]-------~o~←~s~") 
						RageUI.Button("~o~→~s~ Menu ~o~Peds ", "", { RightLabel = "~o~→→" },true, function()
						end, RMenu:Get('menu', 'ped'))
						RageUI.Separator("~p~→~s~-------[ Action staff ]-------~p~←~s~") 
						RageUI.Button("~p~→~s~ Actions ~p~personnelles ", "", { RightLabel = "~p~→→" },true, function()
						end, RMenu:Get('menu', 'perso'))
						RageUI.Button("~p~→~s~ Actions ~p~staff ", "", { RightLabel = "~p~→→" },true, function()
						end, RMenu:Get('menu', 'actionstaff'))
						RageUI.Button("~p~→~s~ Liste des ~p~joueurs ", "", { RightLabel = "~p~→→" },true, function()
						end, RMenu:Get('menu', 'joueurs'))
						RageUI.Separator("~g~→~s~-------[ Action Hrp ]-------~g~←~s~") 
						RageUI.Button("~g~→~s~ Gestions ~g~véhicules ", "", { RightLabel = "~g~→→" },true, function()
						end, RMenu:Get('menu', 'veh'))
						RageUI.Button("~g~→~s~ Options ~g~Hors-Roleplay ", "", { RightLabel = "~g~→→" },true, function()
						end, RMenu:Get('menu', 'world'))
                        RageUI.Separator("~r~→~s~-------[ Aidez ou punissez ]-------~r~←~s~") 
						RageUI.Button("~r~→~s~ Menu ~r~Warns ", "", { RightLabel = "~r~→→" },true, function()
				...
				RageUI.IsVisible(RMenu:Get('menu', 'perso'), true, true, true, function()
					...
					RageUI.Separator(" ↓ ~p~ Gestion Gives ~s~↓ ", nil, {}, true, function(Hovered, Active, Selected)
					end)

					RageUI.Button("~p~→~s~ S'octroyer du Heal",description, {}, true, function(Hovered, Active, Selected)
						if (Selected) then
							SetEntityHealth(GetPlayerPed(-1), 200)
							Notify("~p~→~s~ ~g~Heal effectué~w~")
						end
					end)

					RageUI.Button("~p~→~s~ S'octroyer du Blindage",description, {}, true, function(Hovered, Active, Selected)
						if (Selected) then
							SetPedArmour(GetPlayerPed(-1), 200)
							Notify("~p~→~s~ ~b~Blindage effectué~w~")
						end
					end)

					RageUI.Button("~p~→~s~ S'octroyer de l'argent liquide",description, {}, true, function(Hovered, Active, Selected)
						if (Selected) then
							GiveCash()
							Notify("~p~Give cash effectué~w~")
						end
					end)

					RageUI.Button("~p~→~s~ S'octroyer de l'argent en banque",description, {}, true, function(Hovered, Active, Selected)
						if (Selected) then
							GiveBanque()
							Notify("~p~Give banque effectué~w~")
						end
					end)

					RageUI.Button("~p~→~s~ S'octroyer de l'argent sale",description, {}, true, function(Hovered, Active, Selected)
						if (Selected) then
							GiveND()
							Notify("~p~Give argent sale effectué~w~")
						end
					end)

					RageUI.Separator(" ↓ ~p~Gestions Mouvements~s~ ↓ ", nil, {}, true, function(Hovered, Active, Selected)
					end)

					RageUI.Button("~p~→~s~ Afficher/Cacher ses coordonnées",description, {}, true, function(Hovered, Active, Selected)
						if (Selected) then   
							Admin.showcoords = not Admin.showcoords    
							end   
						end)

					RageUI.Button("~p~→~s~ Se téléporter sur son marqueur", nil, {
					...
					RageUI.Checkbox("~p~→~s~ Noclip", nil, crossthemap,{},function(Hovered,Ative,Selected,Checked)
						if Selected then
							crossthemap = Checked
							if Checked then
								news_no_clip()
					...
					RageUI.Checkbox("~p~→~s~ Nage rapide", description, fastSwim,{},function(Hovered,Ative,Selected,Checked)
						if Selected then
							fastSwim = Checked
							if Checked then
					...
					RageUI.Checkbox("~p~→~s~ Super Sprint", description, fastSprint,{},function(Hovered,Ative,Selected,Checked)
						if Selected then
							fastSprint = Checked
							if Checked then
				...
				RageUI.IsVisible(RMenu:Get('menu', 'actionstaff'), true, true, true, function()
					...
					RageUI.Separator("↓ ~p~Gestion Modération ~s~↓", nil, {}, true, function(_, _, _)
					end)

				RageUI.Button("~p~→~s~ Kick une personne", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
					if (Selected) then
				...
				RageUI.Button("~p~→~s~ Bannir une personne", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
					if (Selected) then
						local quelid = Keyboardput("ID du joueur", "", 3)
				...
				RageUI.Button("~p~→~s~ Débannir une personne", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
					if (Selected) then
					...
					RageUI.Separator("↓ ~p~Intéraction sur un joueur  ~s~↓", nil, {}, true, function(_, _, _)
					end)
					
					RageUI.Button("~p~→~s~ Envoyer~s~ un message à un joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
						if (Selected) then
					...
					RageUI.Button("~p~→~s~ Se téléporter sur un joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
						if (Selected) then
							local quelid = Keyboardput("ID", "", 100)
							ExecuteCommand("goto "..quelid)
							ESX.ShowNotification("~p~Vous venez de vous téléporter à l\'ID : ~p~ " ..quelid)
						end
					end)
					RageUI.Button("~p~→~s~ Téléporter un joueur à vous", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected, target)
						if (Selected) then
							local quelid = Keyboardput("ID", "", 100)
							ExecuteCommand("bring "..quelid)
							ESX.ShowNotification("~p~Vous venez de téléporter l\'ID :~s~ " ..quelid.. " ~p~à vous~s~ !")
						end
					end)
					if superadmin then
						RageUI.Button("~p~→~s~ Attribuer un job~s~ à une personne", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
							if (Selected) then
								...
								if job and grade and quelid then
									...
									ESX.ShowNotification("Vous venez de setjob ~p~"..job.. " " .. grade .. " l\'ID : " ..quelid)
								else
									RageUI.CloseAll()	
								end	
							end
					...
					RageUI.Separator("↓ ~p~Intéraction give sur un joueur  ~s~↓", nil, {}, true, function(_, _, _)
					end)

					RageUI.Button("~p~→~s~ Octroyer du heal~s~ une personne", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
						if (Selected) then
							local quelid = Keyboardput("ID", "", 3)
							if quelid then
								ExecuteCommand("heal "..quelid)
								Notify("~p~Heal de l'ID "..quelid.." effectué~w~")
							else
								RageUI.CloseAll()	
							end
						end
					...
					RageUI.Button("~p~→~s~ Revive~s~ une personne",description, {}, true, function(Hovered, Active, Selected)
						if (Selected) then   
					...
					RageUI.Button("~p~→~s~ Give un item à un joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
						if (Selected) then
							local quelid = Keyboardput("ID", "", 3)
					...
					if superadmin then
						RageUI.Button("~p~→~s~ Give une arme à un joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
							if (Selected) then
								local quelid = Keyboardput("ID du joueur", "", 3)
						...
						RageUI.Separator("↓ ~p~Intéraction Chat  ~s~↓", nil, {}, true, function(_, _, _)
						end)
	
						RageUI.Button("~p~→~s~ Vider le Chat", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
							if (Selected) then
							ExecuteCommand("clear")
							end
						end)
						
						RageUI.Button("~p~→~s~ Faire une Annonce", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
							if (Selected) then
				...
				RageUI.IsVisible(RMenu:Get('menu', 'options'), true, true, true, function()
					...
					RageUI.Separator("↓ ~p~Actions possibles sur le joueurs ~s~↓", nil, {}, true, function(_, _, _)
					end)

					RageUI.Button("~p~→~s~ Envoyer un message au joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
						if (Selected) then
							local msg = Keyboardput("Raison", "", 100)
					...
					if superadmin then
						RageUI.Button("~p~→~s~ Setjob le joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
							if (Selected) then
								local job = Keyboardput("Job", "", 10)
								local grade = Keyboardput("Grade", "", 10)
					...
					RageUI.Button("~p~→~s~ Se téléporter sur le joueur", nil, {}, true, function(Hovered, Active, Selected)
						if (Selected) then
					...
					RageUI.Button("~p~→~s~ Le téléporter à vous", nil, {}, true, function(Hovered, Active, Selected, target)
						if (Selected) then
					...
					RageUI.Button("~p~→~s~ Regarder le joueur", nil, {}, true, function(Hovered, Active, Selected)
						if (Selected) then
					...
					RageUI.Checkbox("~p~→~s~ Freeze/Un-freeze le joueur", description, Frigo,{},function(Hovered,Ative,Selected,Checked)
						if Selected then
							Frigo = Checked
							if Checked then
					...
					RageUI.Separator("↓ ~p~Gestion Gives sur le joueur ~s~↓", nil, {}, true, function(_, _, _)
					end)

					RageUI.Button("~p~→~s~ Heal le joueur", nil, {}, true, function(Hovered, Active, Selected)
						if (Selected) then
					...
					if superadmin then
						RageUI.Button("~p~→~s~ Wipe l'inventaire~s~ du joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
							if (Selected) then
					...
					if superadmin then
						RageUI.Button("~p~→~s~ Wipe les armes~s~ du joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
							if (Selected) then
					...
					RageUI.Button("~p~→~s~ Give un item~s~ au joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
						if (Selected) then
							local item = Keyboardput("Item", "", 10)
							local amount = Keyboardput("Nombre", "", 10)
					...
					if superadmin then
						RageUI.Button("~p~→~s~ Give une arme~s~ au joueur", nil, {RightLabel = nil}, true, function(Hovered, Active, Selected)
							if (Selected) then
				...
				RageUI.IsVisible(RMenu:Get('menu', 'sanction'), true, true, true, function()
					RageUI.Separator("~r~ID~s~ ~r~[~s~ ~b~"..IdSelected.."~s~ ~r~]~s~", nil, {}, true, function(Hovered, Active, Selected)
					end)

					RageUI.Separator("~r~Joueur~s~ "..GetPlayerName(GetPlayerFromServerId(IdSelected)), nil, {}, true, function(Hovered, Active, Selected)
					end)
				...
				RageUI.IsVisible(RMenu:Get('menu', 'veh'), true, true, true, function()
					...
					RageUI.Button("~g~→~s~ Give un véhicule~s~ ~g~(avec clé)", nil, {}, true, function(_, _, Selected)
					if Selected then
					...
					RageUI.Button("~g~→~s~ Faire apparaître un véhicule", nil, {}
					, true, function(_, _, Selected)
					if Selected then
					...
					RageUI.Button("~g~→~s~ Réparer le véhicule", nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
						if (Selected) then   
					...
					RageUI.Button("~g~→~s~ Custom~s~ au maximum", nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
						if (Selected) then   
						FullVehicleBoost()
						end   
					end) 

					RageUI.Button("~g~→~s~ Changer la plaque~s~ du véhicule", nil, {}, true, function(_, Active, Selected)
					if Selected then
					...
					RageUI.Button("~g~→~s~ Mettre en fourrière~s~ le véhicule", nil, {}, true, function(_, Active, Selected)
					if Active then
						ShowMarker()
					end
					if Selected then
					...
					RageUI.Button("~g~→~s~ Changer la couleur~s~ du véhicule", nil, {RightLabel = ""},true, function()
				...
				RageUI.IsVisible(RMenu:Get('menu', 'customcolor'), true, true, true, function()
					RageUI.Button("~g~→~s~ Bleu", nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
						if (Selected) then   
					...
					RageUI.Button("~g~→~s~ Rouge", nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
						if (Selected) then   
						local vehicle = GetVehiclePedIsIn(PlayerPedId(), true)
					...
					RageUI.Button("~g~→~s~ Vert", nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
						if (Selected) then   
						local vehicle = GetVehiclePedIsIn(PlayerPedId(), true)
					...
					RageUI.Button("~g~→~s~ Noir", nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
						if (Selected) then   
						local vehicle = GetVehiclePedIsIn(PlayerPedId(), true)
					...
					RageUI.Button("~g~→~s~ Rose", nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
						if (Selected) then   
						local vehicle = GetVehiclePedIsIn(PlayerPedId(), true)
					...
					RageUI.Button("~g~→~s~ Blanc", nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
						if (Selected) then   
						local vehicle = GetVehiclePedIsIn(PlayerPedId(), true)
				...
				RageUI.IsVisible(RMenu:Get('menu', 'ped'), true, true, true, function()
					...
					RageUI.Button("~o~→~s~ Tenu Staff", nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
						if (Selected) then   
						local j1 = PlayerId()
		  ...
		  RageUI.IsVisible(RMenu:Get('menu', 'gestr'), true, true, true, function()
			...
			RageUI.Button("~r~→~s~ Se téléporter~s~ au joueur", nil, {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					ExecuteCommand("goto "..sonid)
				end
			end)

			RageUI.Button("~r~→~s~ Le téléporter~s~ vers soi", nil, {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					ExecuteCommand("bring "..sonid)
				end
			end)

			RageUI.Button("~r~→~s~ Spectate~s~ le joueur", nil, {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					ExecuteCommand("spect "..sonid)
				end
			end)

			RageUI.Checkbox("~r~→~s~ Freeze/Unfreeze~s~ le joueur", description, Frigo,{},function(Hovered,Ative,Selected,Checked)
				if Selected then
					Frigo = Checked
					if Checked then
			...
			RageUI.Button("~r~→~s~ Supprimer le report", nil, {}, true, function(Hovered, Active, Selected)
				...
				RageUI.IsVisible(RMenu:Get('menu', 'world'), true, true, true, function()
					...
					RageUI.Checkbox("~g~→~s~ Afficher~s~ les Noms", description, affichername,{},function(Hovered,Ative,Selected,Checked)
						if Selected then
					...
					RageUI.Checkbox("~g~→~s~ Afficher les Blips", description, afficherblips,{},function(Hovered,Ative,Selected,Checked)
						if Selected then
					...
					RageUI.Button("~g~→~s~ Devenir~s~ Invincible", nil, {RightLabel = "~g~On~s~ | ~r~Off~s~"}, true, function(Hovered, Active, Selected)
						if (Selected) then       
...
function news_no_clip()
  ...
  if noclip then -- activé
	...
	invisible = true
	Notify("Votre Noclip à bien été ~g~activé")
  else -- désactivé
